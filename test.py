...
from data.dataset_test_unimodal import get_data_loaders
...
def main():
    ...
    save_model_name = f'checkpoints/unimodal_determine/latest_no_att_no_cls_w_gatortron-base_512_cls_{config["num_classes"]}_mri_{config["mri_report_section"]}.pt'
    # save_model_name = f'checkpoints/unimodal_determine/latest_no_att_no_cls_w_gatortron-base_512_cls_{config["num_classes"]}_pa_{config["pa_report_section"]}.pt'
